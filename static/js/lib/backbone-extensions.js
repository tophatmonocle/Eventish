(function () {
    ...
    function bindOnce (event, callback) {
        function callbackwrap() {
            this.unbind(event,callbackwrap)
            callback.apply(this,arguments)
        }
        this.bind(event,callbackwrap)
    }

    Backbone.Model.prototype.bindOnce =
        Backbone.Collection.prototype.bindOnce = bindOnce;
